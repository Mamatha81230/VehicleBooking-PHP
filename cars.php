...
<body>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Cars Section</li>
    </ol>
    <?php

      $ret="SELECT * FROM tms_vehicle where v_category='Cars' ORDER BY RAND() LIMIT 10 "; //get all feedbacks
    ...
    ?>
        ...
        <a class="btn btn-success" href="usr/">Hire your Car
