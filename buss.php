...
<body>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Buss Section</li>
    </ol>
    <?php

      $ret="SELECT * FROM tms_vehicle where v_category='Buss AND Van'  ORDER BY RAND() LIMIT 10 "; //get all feedbacks
    ...
    ?>
        ...
        <a class="btn btn-success" href="usr/">Hire your BUSS
