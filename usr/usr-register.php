...
<?php if(isset($succ)) {?>
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-4">
        <div class="form-label-group">
          <input type="text" required class="form-control" id="lastName" name="u_lname">
          <label for="lastName">Last name</label>
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-label-group">
          <input type="text" required pattern="[0-9]{10}" required class="form-control" id="contactNumber" name="u_phone">
          <label for="contactNumber">Contact (10 digits)</label>
        </div>
      </div>
    </div>
  </div>
  <div class="form-group">
    <div class="form-label-group">
      <input type="text" required class="form-control" id="inputAddress" name="u_addr">
      <label for="inputAddress">Address</label>
    </div>
  </div>
  <div class="form-group" style="display:none">
    <div class="form-label-group">
      <input type="text" class="form-control" id="userCategory" value="User" name="u_category">
  ...
  <div class="form-group">
    <div class="form-row">
      <div class="col-md-12">
        <div class="form-label-group">
          <input type="password" class="form-control" id="inputPassword" name="u_pwd" required>
